 ...
 * Slot map:
 *  ├── Lighting
 *  ├── Hemisphere fill (no remote HDRI — production-safe)
...
// ── Phase 4 import (uncomment when built) ────────────────────────────────────
...
export default function SceneContent() {
  return (
    <>
      ...
      {/*
        No remote Environment preset: drei HDRIs load from CDNs that often fail
        in production (Vercel, ad blockers). Hero CubeCamera + lights provide IBL.
      */}
      <hemisphereLight intensity={0.35} color="#2a4a6e" groundColor="#04090f" />
