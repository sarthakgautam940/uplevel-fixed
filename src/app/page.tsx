 ...
 * Hero: 3D glass canvas behind. Full sections below.
 */
...
function StatsSection() {
  ...
  return (
    <section
      id="stats"
      style={{ borderTop: '1px solid rgba(255,255,255,0.04)', borderBottom: '1px solid rgba(255,255,255,0.04)', zIndex: 10, position: 'relative', background: 'transparent' }}
    >
...
function CarouselSection() {
  return (
    <section
      id="carousel-section"
      className="relative"
      style={{ minHeight: '150vh', zIndex: 10, background: 'transparent' }}
    >
...
function FeaturesSection() {
  ...
  return (
    <section id="features" className="section-py section-px" style={{ position: 'relative', zIndex: 10, background: 'transparent' }}>
...
function ProblemSection() {
  return (
    <section id="problem" className="section-py section-px" style={{ textAlign: 'center', position: 'relative', zIndex: 10, background: 'transparent' }}>
      <div className="section-max">
...
function PricingSection() {
  return (
    <section id="pricing" className="section-px" style={{ paddingBottom: 'clamp(64px,8vw,128px)', position: 'relative', zIndex: 10, background: 'transparent' }}>
      <div className="section-max">
        <div
...
function FooterSection() {
  return (
    <footer
      ...
      style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', background: 'transparent' }}
    >
      <div
        id="footer-text"
